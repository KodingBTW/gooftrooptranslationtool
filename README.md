This tool allows you to extract the text from the questions in the SNES game "Goof Troop (USA).sfc", and then easily reinsert it. The pointer table will be updated automatically.
